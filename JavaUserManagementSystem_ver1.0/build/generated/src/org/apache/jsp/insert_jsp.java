...
if(udb.getName() != null){out.print(udb.getName());}
      out.write("\">\n");
      out.write("        <br><br>\n");
      out.write("\n");
      out.write("        生年月日:\n");
...
if(udb.getType().equals("1")){out.print("checked='checked'");}
      out.write(">エンジニア<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"2\" ");
if(udb.getType().equals("2")){out.print("checked='checked'");}
      out.write(">営業<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"3\" ");
if(udb.getType().equals("3")){out.print("checked='checked'");}
      out.write(">その他<br>\n");
      out.write("        <br>\n");
      out.write("\n");
      out.write("        電話番号:\n");
      out.write("        <input type=\"text\" name=\"tell\" value=\"");
if(udb.getTell() != null){out.print(udb.getTell());}
      out.write("\">\n");
      out.write("        <br><br>\n");
      out.write("\n");
      out.write("        自己紹介文\n");
...
if(udb.getComment() != null){out.print(udb.getComment());}
